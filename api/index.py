...
def advanced_sentiment_logic(text):
    # Weighted Dictionary: Higher numbers = stronger sentiment
    scores = {
        # Positive
        'excellent': 3, 'amazing': 3, 'perfect': 3, 'love': 3,
        'good': 1, 'nice': 1, 'happy': 1, 'success': 2, 'working': 1,
        'fast': 1, 'great': 2, 'awesome': 2, 'smart': 2, 'cool': 1,
        # Negative
        'terrible': -3, 'worst': -3, 'horrible': -3, 'hate': -3,
        'bad': -1, 'slow': -1, 'error': -2, 'failed': -2, 'broken': -2,
        'difficult': -1, 'poor': -1, 'wrong': -1, 'sad': -1
    }
    ...
    for word in words:
        ...
        total_score += scores.get(clean_word, 0)
    
    if total_score >= 2: return "Highly Positive 🌟"
    elif total_score == 1: return "Positive 😊"
    elif total_score <= -2: return "Highly Negative 😡"
...
def home():
    ...
    <head>
        ...
        <style>
            ...
            textarea { background: #0f172a !important; color: white !important; border: 1px solid #475569 !important; border-radius: 8px !important; transition: 0.2s; }
    ...
    <body>
        <div class="container" style="max-width: 750px;">
            <div class="main-card shadow-lg">
                <h2 class="text-center mb-5 text-white">☁️ Serverless NLP Engine</h2>
